...
const CourseProgress = ({ progress, totalLessons }: CourseProgressProps) => {
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="mb-2 flex items-center justify-between">
              <p className="text-[#2D3748]">Hoàn thành khóa học</p>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl bg-[#52aaa5]/5 p-4">
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-[#2D3748]">Bài học</span>
              </div>
            ...
            <div className="rounded-xl bg-[#52aaa5]/5 p-4">
              <div className="mb-2 flex items-center gap-2">
                <CheckCircle2 className="h-5 w-5 text-[#52aaa5]" />
                <span className="text-sm font-medium text-[#2D3748]">Câu hỏi</span>
              </div>
              <div className="flex items-end justify-between">
                <p className="text-2xl font-bold text-[#52aaa5]">
            ...
            <div className="rounded-xl bg-[#52aaa5]/5 p-4">
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-[#2D3748]">Thời gian</span>
              </div>
              <div className="flex items-end justify-between">
                <p className="text-2xl font-bold text-[#52aaa5]">

import { Relationship, RelationshipType } from "../../../type/wiki";
...
export function EditExistingPhraseRelationshipSection({
  existingRelationships,
  handleRemoveRelationship,
}: Props) {
  const relationshipsByType = RELATIONSHIP_TYPES.map((t: RelationshipType) => ({
    type: t,
            ...
            <>
              ...
              <div className="flex items-center gap-2 mb-3">
                <span className="inline-block rounded-lg text-[15px] text-black">
                  {relationshipTypeLabels[type].label}
                </span>
              ...
              <div
                key={type}
                className="border border-gray-300 rounded-lg p-2 hover:outline hover:outline-[#52aaa5] hover:outline-1"
              >
                <div className="flex flex-wrap gap-2">
                  ...
                  {items.map((relationship: Relationship) => (
                    ...
                    >
                      <span>{relationship.phrase || relationship.word}</span>

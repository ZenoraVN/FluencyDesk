...
import {
  CreatePhrasePartOfSpeechSection,
  PartOfSpeechOption
} from './CreatePhrasePartOfSpeechSection'
import { CustomButton } from '../../../../../componentsButton/CustomButton'
interface Props {
  form: UseFormReturn<CreatePhraseFormData>
  definitionFields: UseFieldArrayReturn<CreatePhraseFormData, 'definitions'>['fields']
  appendDefinition: UseFieldArrayReturn<CreatePhraseFormData, 'definitions'>['append']
  removeDefinition: UseFieldArrayReturn<CreatePhraseFormData, 'definitions'>['remove']
  partsOfSpeechOptions: PartOfSpeechOption[]
  isVietnamese: (text: string) => boolean
  isEnglish: (text: string) => boolean
}
export function CreatePhraseDefinitionSection({
  form,
  definitionFields,
  appendDefinition,
  removeDefinition,

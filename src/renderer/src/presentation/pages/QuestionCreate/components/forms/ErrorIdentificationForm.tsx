...
export const ErrorIdentificationForm: FC<ErrorIdentificationFormProps> = ({
  ...
  useEffect(() => {
    form.trigger(['error_identification_question.question', 'error_identification_answers'])
        ...
        return (
          <button
            ...
            className={`inline-block mx-1 cursor-pointer ${
              selectedBlankNumber === number ? 'text-blue-600' : 'text-gray-400 hover:text-blue-500'
            }`}
          >
            ___({number})___
          </button>
        ...
        <div className="space-y-4">
            ...
            <FormField
              ...
              render={({ field, fieldState: { error } }) => (
                <FormItem>
                    ...
                    <div className="mt-2 space-y-2">
                      <div className="flex items-center gap-1 p-1 border border-[#52aaa5]/20 rounded-t-lg bg-transparent">
                        ...
                        <div className="flex items-center gap-1 px-2">
                          <button type="button" className="p-2 rounded hover:bg-[#52aaa5]/10">
                      ...
                      <div className="relative">
                        <textarea
                          ...
                          className={`w-full min-h-[100px] p-3 rounded-b-lg bg-transparent text-[#2D3748] placeholder:text-[#718096] outline-none border resize-none overflow-hidden ${
                            error || form.formState.errors.error_identification_answers?.root
                  ...
                  {(error || form.formState.errors.error_identification_question?.question) && (
                    <div className="text-sm text-red-500 mt-1">
                      {error?.message ||
                        form.formState.errors.error_identification_question?.question?.message}
                    </div>
                  )}
                </FormItem>
              )}
          ...
          <div className="rounded-lg shadow-s">
            ...
            <div className="p-4  border border-gray-200 rounded-b-lg min-h-[80px]">
              {question ? (
                <div className="text-[#2D3748] leading-relaxed text-base">{renderQuestion()}</div>
              ) : (
            ...
            <div className="flex justify-between items-center pr-3 py-3 border-b border-gray-200">
              <div>
                ...
                {form.formState.errors.error_identification_answers?.root && (
                  <div className="text-sm text-red-500 mt-1">
                    {form.formState.errors.error_identification_answers.root.message}
                  </div>
                )}
              </div>
              <Button
                ...
                return (
                  ...
                  >
                    <div className="mb-2 flex justify-between items-center">
                      <span className="text-sm font-medium text-[#2D3748]">Đáp án {index + 1}</span>
                      <Button
                        type="button"
                    ...
                    <div className="space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field, fieldState: { error } }) => (
                          <FormItem>
                            <FormLabel className="text-[#2D3748] font-medium">Từ sai</FormLabel>
                            <FormControl>
                              <textarea
                                {...field}
                      ...
                      <FormField
                        ...
                        render={({ field, fieldState: { error } }) => (
                          <FormItem>
                            <FormLabel className="text-[#2D3748] font-medium">Từ đúng</FormLabel>
                            <FormControl>
                              <textarea
                                {...field}

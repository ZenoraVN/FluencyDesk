...
const colorClasses = {
  ...
  NOT_GIVEN: 'bg-yellow-100 text-yellow-700 border-yellow-400 hover:bg-yellow-200'
}
...
export const ViewTrueFalseNotGivenSection: FC<Props> = ({ question }) => {
  ...
  return (
    <div className="pt-6">
      <h3 className="text-lg font-semibold text-gray-800 mb-5">Các câu hỏi True/False/Not Given</h3>

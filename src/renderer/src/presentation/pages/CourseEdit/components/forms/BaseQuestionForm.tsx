...
export const BaseQuestionForm: FC<BaseQuestionFormProps> = ({
            ...
            <div className="p-5 rounded-lg border border-gray-200">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-lg font-medium text-[#52aaa5] mb-1">
                    {skillInfo.label}
                  </div>
                      ...
                      style={{
                        backgroundColor:
                          field.value === level.value
                            ...
                            : `${level.color}20`,
                        color:
                          field.value === level.value ? "white" : level.color,
                      }}
                    >
                      {level.label}
                    </button>
  ...
  `}
                        ...
                        {showTopicSuggestions && topicInput && (
                          <div className="absolute z-50 left-0 right-0 top-full mt-1 py-1 rounded-lg border shadow-lg max-h-[200px] overflow-y-auto backdrop-blur bg-white/80">
                            {filteredTopics.length > 0 ? (
                              ...
                              <div className="px-3 py-2 text-[#2D3748]">
          ...
          <FormField
            ...
            rules={{
              validate: (value) =>
                (value && value.length > 0) || "Vui lòng chọn ít nhất một tag",
            }}
            render={({}) => (
              <FormItem>
                <FormLabel className="text-[#2D3748] font-medium">
          ...
          <FormField
            ...
            rules={{
              validate: (value) => {
                ...
                if (wordCount > 1000)
                  return "Tổng quan không được vượt quá 1000 từ";
                return true;
              },
            }}
            render={({ field }) => (

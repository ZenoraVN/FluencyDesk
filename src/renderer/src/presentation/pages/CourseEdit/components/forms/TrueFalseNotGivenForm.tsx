...
interface RenderProps<
  TName extends TrueFalseNotGivenFormPath = TrueFalseNotGivenFormPath
> {
    ...
    rules: {
      ...
      validate: {
        ...
        noDuplicates: (
          ...
          return (
            questions.length === uniqueQuestions.size ||
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center pb-2 border-b border-gray-200">
            ...
            {fields.length < 10 && (
              <Button
                type="button"
                onClick={() =>
                  append({ question: "", answer: "TRUE", explain: "" })
                }
          ...
          <div className="flex flex-col gap-4">
            {fields.map((field, index) => (
              <div
                key={field.id}
                className="relative rounded-lg border border-gray-100 p-4"
              >
